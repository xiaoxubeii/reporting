...
export const ROUTE_DOMAINS: Record<string, RouteAccess> = {
  ...
  'api/feeds/connection': { domain: 'dealflow', feature: 'feeds', level: { POST: 'read', DELETE: 'read' } },
  'api/feeds/discover': { domain: 'dealflow', feature: 'feeds', level: { POST: 'read' } },
  'api/feeds/entries': { domain: 'dealflow', feature: 'feeds' },
  ...
  'api/feeds/subscriptions/[id]': { domain: 'dealflow', feature: 'feeds', level: { DELETE: 'read' } },
  'api/search': { domain: 'dealflow', feature: 'search', level: { POST: 'read' } },
