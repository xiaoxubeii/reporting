...
- focused verification: final review suite passes 9 files/112 tests; the environment-gated disposable local-Supabase profile integration passes 1 test. Changed-file ESLint, strict OpenSpec, and diff-check pass; TypeScript reports only the known platform-landing TS2802 baseline.
