...
- [x] 2.6 Route SearXNG engine traffic directly through the Privoxy service on port 8118 using its Docker network, with proxy-aware health and deployment contract coverage.
